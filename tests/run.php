...
/**
 * @file plugins/generic/coAuthorParticipants/tests/run.php
 *
...
define('COAUTHORPARTICIPANTS_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\\plugins\\generic\\coAuthorParticipants\\tests\\' . basename($file, '.php');
